...
$this->title = Html::encode($settings['site_name']) .' › 创建管理员帐号';
?>
</div>
<div id="Main" style="margin: 0px 20px 0px 20px;">
<div class="sep20"></div>
<div class="box">
<div class="header"><?php echo Html::a(Html::encode($settings['site_name']) , ['/']), '<span class="chevron">&nbsp;›&nbsp;</span>创建管理员帐号';?></div>
<?php if ( !empty($error) ) {?>
...
<div class="form-group">
    ...
    <?php echo Html::submitButton('创建', ['class' => 'super normal button']); ?>
</div>
<?php ActiveForm::end(); ?>
</div>
</div>
