...
<div class="sep20"></div>
<div class="box">
<div class="header"><div class="fr f12"><span class="fade">共 <?php echo $siteinfo['topics'];?> 个主题</span></div><?php echo Html::a(Html::encode($settings['site_name']), ['/']); ?> <span class="chevron">&nbsp;›&nbsp;</span> 最近的主题</div>
