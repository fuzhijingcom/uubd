...
class WysibbEditor extends Editor implements PluginInterface
{
    ...
    public function registerAsset($view)
    {
        ...
        $view->registerJs("$('#editor').wysibb({lang:'cn', buttons: 'bold,italic,underline,strike,fontcolor,justifyleft,justifycenter,justifyright,bullist,numlist,img,link,code,quote'});");
    }
